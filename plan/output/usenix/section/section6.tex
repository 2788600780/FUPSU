...
This work proposes F-PSU, the first forward-private updatable PSU protocol.
F-PSU achieves per-epoch cell scanning $29$--$23{,}756\times$ smaller than the
...
update counts, and show that F-PSU matches this bound. A natural byproduct
...
in the secure computation toolbox, and that F-PSU provides a solid
