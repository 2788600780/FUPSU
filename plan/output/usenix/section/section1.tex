...
Jia+24~\cite{Jia+24} & PSU & No  & No  & No\textsuperscript{a} & No  & $O(n \log n)$ \\
Tu+25~\cite{Tu+25}   & PSU & No  & No  & No\textsuperscript{a} & No  & $O(n)$ \\
...
\textsuperscript{a}Enhanced security model (no within-execution leakage).}
