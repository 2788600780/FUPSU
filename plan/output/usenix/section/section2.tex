...
\smallskip
\end{minipage}}
\captionof{figure}{The ideal functionality of 1-out-of-2 Oblivious Transfer.}
\label{fig:f-ot}
\end{center}
...
\smallskip
\end{minipage}}
\captionof{figure}{The ideal functionality of Oblivious PRF.}
\label{fig:f-oprf}
\end{center}
...
\smallskip
\end{minipage}}
\captionof{figure}{The ideal functionality of (static) Private Set Union.}
\label{fig:f-psu}
\end{center}
